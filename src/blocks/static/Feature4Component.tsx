...
function FeatureBlock() {
  return (
    <section className="lg:px-40 lg:py-16 md:px-20 md:py-8 px-4 py-8 lg:h-fit">
      <div className="flex flex-col gap-y-9 lg:flex-row-reverse md:flex-row md:justify-between">
